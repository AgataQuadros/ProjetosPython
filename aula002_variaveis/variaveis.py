...
print('\033[0m \033[32m altura \033[0m é do tipo : ', type(nome))
print('\033[0m \033[32m peso \033[0m é do tipo : ', type(nome))
print('\033[0m \033[32m doador \033[0m é do tipo : ', type(nome))
print('\033[0m \033[32m complexo \033[0m é do tipo : ', type(nome))
print('\033[0m \033[32m PI \033[0m é do tipo : ', type(nome))
print('\033[0m \033[32m nome \033[0m é do tipo : ', type(nome))
print('-'*70)
print('')